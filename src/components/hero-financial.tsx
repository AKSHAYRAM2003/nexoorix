...
const EcommerceDash = { src: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop' }
...
export const HeroFinancial = () => {
  ...
  return (
    <section
      ref={timelineRef}
      className="min-h-screen bg-[#f7f9fc] text-[#1e293b] relative overflow-x-clip flex flex-col items-center"
    >
      ...
      <div className="relative z-10 text-center pt-24 pb-16 px-4 flex flex-col gap-6">
        ...
        <div className="flex gap-4 justify-center">
          <TimelineAnimation
            ...
            animationNum={4}
            timelineRef={timelineRef}
            className="px-6 bg-linear-to-br from-blue-500 via-blue-400 to-blue-200 text-white text-xl rounded-full shadow-sm transition py-3 border border-blue-300 active:scale-95"
          >
            Get Started
          </TimelineAnimation>
          <TimelineAnimation
            ...
            animationNum={5}
            timelineRef={timelineRef}
            className="px-6 bg-linear-to-br from-neutral-50 via-neutral-100 to-neutral-300 text-black text-xl rounded-full shadow-sm transition py-3 border border-neutral-300 active:scale-95"
          >
            Learn more
          </TimelineAnimation>
        </div>
